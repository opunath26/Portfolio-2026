    ...
    >
      ...
      <div className="space-y-8 order-2 lg:order-1">
        ...
        <div className="gap-8 grid grid-cols-3 pt-8 border-white/20 border-t">
          <div><h3 className="font-extrabold text-3xl text-accent-pink">1.5+</h3><p className="text-white/60 text-sm">Years of Practice</p></div>
          <div><h3 className="font-extrabold text-3xl text-accent-pink">15+</h3><p className="text-white/60 text-sm">Full Projects</p></div>
          <div><h3 className="font-extrabold text-3xl text-accent-pink">580+</h3><p className="text-white/60 text-sm">Hours of Coding</p></div>
        </div>
      </div>
